...
import { designSkills } from "@/lib/data/skills";
...
export function DesignSkills() {
  return (
    <section
      ...
      aria-labelledby="design-skills-title"
    >
      <div className="relative mx-auto max-w-[1200px] px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          >
            <h2
              id="design-skills-title"
              className="text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.05] tracking-[-0.03em] text-white max-w-[18ch]"
            >
              Strumenti di <span className="text-accent-red">design</span> che uso.
            </h2>
            <p className="text-sm md:text-base text-zinc-500 leading-relaxed max-w-[42ch]">
              Non sono designer di mestiere, ma traduco i mockup in interfacce
              fedeli e ragiono in token e componenti.
            </p>
          </motion.div>
